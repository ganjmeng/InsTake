                    ...
                    public void onConsentFormClosed(ConsentStatus consentStatus, Boolean userPrefersAdFree) {
                        ...
                        switch (consentStatus) {
                            case NON_PERSONALIZED:
                                ...
                                try {
                                    if(((LinearLayout) guide.linearlayout).getChildCount() > 0)
                                        ((LinearLayout) guide.linearlayout).removeAllViews();
                                    admob.admobBannerCall(MainActivity.context,guide.linearlayout);
